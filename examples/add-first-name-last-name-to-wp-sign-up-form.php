...
*/
	...
	/* 
		...
		--------
		Guide: 
			https://zerobscrm.com/kb/knowledge-base/how-to-capture-first-and-last-name/
		--------
...
function zerobscrm_register_form() {
    ...
    add_filter( 'registration_errors', 'zerobscrm_registration_errors', 10, 3 );
    function zerobscrm_registration_errors( $errors, $sanitized_user_login, $user_email ) {
